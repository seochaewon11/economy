...
배치했습니다. 마커를 클릭/hover하면 해당 지사의 주소·전화번호가 옆 패널에 표시됩니다.
...
## 🤖 AI 활용 프로세스
Claude Code와 함께 스크롤 인터랙션 설계·GSAP 애니메이션 구현·실제 지리 데이터 조사(대한민국 SVG
지도)·리팩터링을 반복하며 작업했습니다. (실제 사용한 프롬프트를 적어주세요)
